...
X_train, y_train = get_input('/Users/acepor/Work/patsnap/code/pat360ner/data/rnn_train.txt')
X_test, y_test = get_input('/Users/acepor/Work/patsnap/code/pat360ner/data/rnn_test1.txt')
X_val, y_val = get_input('/Users/acepor/Work/patsnap/code/pat360ner/data/rnn_test2.txt')
...
## Do we need embedding layer? or just convert input to embedding? tflearn.input_data([None, MAX_DOCUMENT_LENGTH, EMBEDDING_SIZE])
## Ans : no not needed, embedding layer is doing this transform
